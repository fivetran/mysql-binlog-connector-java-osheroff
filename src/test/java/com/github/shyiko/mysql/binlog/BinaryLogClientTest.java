...
public class BinaryLogClientTest {
    ...
    public void testNoConnectionTimeout() throws Exception {
        new BinaryLogClientOsheroff("_localhost_", 3306, "root", "mysql").connect(0);
    }

    @Test(timeOut = 15000)
    public void testConnectionTimeout() throws Exception {
        final BinaryLogClientOsheroff binaryLogClient = new BinaryLogClientOsheroff("localhost", 33059, "root", "mysql");
    ...
    public void testNullEventDeserializerIsNotAllowed() throws Exception {
        new BinaryLogClientOsheroff("localhost", 3306, "root", "mysql").setEventDeserializer(null);
    }

    @Test(timeOut = 15000)
    public void testDisconnectWhileBlockedByFBRead() throws Exception {
        final BinaryLogClientOsheroff binaryLogClient = new BinaryLogClientOsheroff("localhost", 33061, "root", "mysql");
